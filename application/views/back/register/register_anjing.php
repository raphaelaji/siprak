            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Register Anjing</h4> </div>
  ...
  echo validation_errors('<p class="warning" style="margin: 10px 20px;">','</p>');
   ?>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0" align="center">Registrasi Anjing</h3>
                            <p class="text-muted m-b-30 font-13" align="center"> Form Registrasi </p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>back/register/tambah_anjing">
                                         <div class="control-group">
                                    <label class="control-label">No Registrasi Anjing <i style="color:red">*</i></label>
                                    <div class="controls">
                                   
                                        <input type="text" class="form-control" name="kode_anjing" id="kode_anjing" readonly="readonly" value="<?php echo $kode; ?>"/>
                    ...
                    <?php } ?>
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="jenis_anjing" id="jenis_anjing" placeholder="Enter jenis Anjing"> </div>
                                      <div class="form-group">
