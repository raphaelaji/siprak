            ...
            <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit Data Sapi</li>
                    </ol>
                </div>
            </div>
              ...
              <div class="container-fluid">
                <div class="row">
                    <div class="col-sm-12">
                      <div class="card">
                        <div class="white-box">
                            <h3 class="box-title m-b-0" align="center">Edit Sapi</h3>
                            <p class="text-muted m-b-30 font-13" align="center"> Form Edit Sapi </p>
                            <div class="row">
                                <div class="col-sm-12 col-xs-12">
                                    <?php 
                            foreach($data_sapi as $list) { ?>
                                    <form class="form-horizontal" method="post" action="<?php echo base_url() ?>back/sapi/edit_aksi">
                                        <div class="control-group">
                                    <input type="hidden" name="id_sapi" class="form-control" value="<?php echo $list['id_sapi']; ?>" />
                                    </div>
                                         <div class="control-group">
                                    <label class="control-label">No Registrasi Sapi <i style="color:red">*</i></label>
                                    <div class="controls">
                                   
                                        <input type="text" class="form-control" name="kode_sapi" id="kode_sapi" readonly="readonly" value="<?php echo $list['kode_sapi']; ?>"/>
                                        <small><?php echo form_error('kode') ?></small>
                                    </div>
                                </div>
                                        <div class="form-group">
                                            <label for="nama_sapi">nama sapi</label>
                                            <input type="text" class="form-control" name="nama_sapi" id="nama_sapi" placeholder="Enter Nama Sapi" value="<?php echo $list['nama_sapi']; ?>"> </div>
