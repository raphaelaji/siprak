...
INSERT INTO `tb_anjing` (`id_anjing`, `kode_anjing`, `nama_anjing`, `id_user`) VALUES
(1, 'A-1001', 'qwer', 4),
(2, 'A-1002', 'qwertadsfghj', 4),
(3, 'A-1003', 'asdfgh', 2),
(4, 'A-1004', 'sdfgh', 4);
...
INSERT INTO `tb_diagnosa` (`id_diagnosa`, `id_user`, `id_anjing`, `id_penyakit`, `tgl_diagnosa`, `hasil`, `id_bayes`) VALUES
...
(2, 'PD-1001', 'asdf', 'dsf', 'L', 'dsf', 'd4b2758da0205c1e0aa9512cd188002a', 2),
(3, 'PD-1002', 'werty', 'sdfg', 'L', 'a', '0cc175b9c0f1b6a831c399e269772661', 1),
(4, 'PD-1003', 'dfgh', 'dsfgh', 'L', 's', '03c7c0ace395d80182db07ae2c30f034', 2),
(5, 'PD-1004', 'sdfgh', 'ASDF', 'L', 'ASD', '3f931c18b44ac93ac5b4b6c653f7c0b0', 1);
...
(173, 1, 1, 'Herpes simpleks', 'Demam', 0.7, 1),
...
(173, 5, 5, 'Herpes simpleks', 'Rasa Gatal', 0.2, 1),
(173, 6, 6, 'Herpes simpleks', 'Rasa panas/terbakar', 0, 0),
(173, 7, 7, 'Herpes simpleks', 'Myalgia/nyeri pada bagian otot', 0, 0),
(173, 8, 8, 'Herpes simpleks', 'Kemerahan pada daerah kulit', 0, 0),
(173, 9, 9, 'Herpes simpleks', 'Edema kulit', 0.5, 1),
...
(174, 14, 5, 'Herpes Zoster', 'Rasa Gatal', 0.5, 1),
...
--
ALTER TABLE `tb_anjing`
  MODIFY `id_anjing` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `tb_bobot`
  MODIFY `id_bobot` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT for table `tb_diagnosa`
--
ALTER TABLE `tb_diagnosa`
  MODIFY `id_diagnosa` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `tb_pemeriksaan`
  MODIFY `id_pemeriksaan` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
